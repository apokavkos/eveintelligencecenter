...
use Apokavkos\EveIntelligenceCenter\Models\MarketHub;
use Apokavkos\EveIntelligenceCenter\Models\MarketSnapshot;
use Apokavkos\EveIntelligenceCenter\Models\SavedFit;
use Apokavkos\EveIntelligenceCenter\Models\SavedFitItem;
use Apokavkos\EveIntelligenceCenter\Models\SavedFitGroup;
use Apokavkos\EveIntelligenceCenter\Models\SavedExport;
use Apokavkos\EveIntelligenceCenter\Models\SavedExportItem;
use Apokavkos\EveIntelligenceCenter\Services\MarketPriceService;
use Apokavkos\EveIntelligenceCenter\Services\MarketSyncService;
use Apokavkos\EveIntelligenceCenter\Services\ReactionDataService;
...
class MarketController extends Controller
{
    ...
    public function markup(Request $request)
    {
        ...
        return view('eveintelligencecenter::market.markup', compact('hubs', 'selectedHubId', 'report'));
    }
    ...
    public function stock(Request $request)
    {
        ...
        return view('eveintelligencecenter::market.stock', compact('hubs', 'selectedHubId', 'report'));
    }
    ...
    public function doctrineDashboard()
    {
        ...
        return view('eveintelligencecenter::market.doctrine', compact('hubs', 'selectedHubId', 'savedFits', 'savedGroups', 'savedExports', 'lastSync'));
    }
    ...
    public function fittings(Request $request)
    {
        ...
        return view('eveintelligencecenter::market.fittings', compact('hubs', 'selectedHubId', 'results', 'savedFits', 'savedGroups', 'savedExports', 'lastSync'));
    }
