...
use Apokavkos\EveIntelligenceCenter\Models\Stockpile;
use Apokavkos\EveIntelligenceCenter\Models\StockpileItem;
use Illuminate\Support\Facades\DB;
use Apokavkos\EveIntelligenceCenter\Services\StockpileLogisticsService;
...
class StockpileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('eveintelligencecenter::stockpiles.index', compact('stockpiles', 'locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('return_to_wizard')) {
            return redirect()->route('eveintelligencecenter::stockpiles.workflow', ['mode' => 'wizard', 'step' => 1])->with('success', 'Stockpile created. Now move to Step 2.');
        }

        return redirect()->route('eveintelligencecenter::stockpiles')->with('success', 'Stockpile created successfully.');
    }

    public function delete($id)
    {
        Stockpile::where('id', $id)->where('user_id', auth()->user()->id)->delete();
        return redirect()->route('eveintelligencecenter::stockpiles')->with('success', 'Stockpile deleted successfully.');
    }
    ...
    public function industry($id)
    {
        ...
        return view('eveintelligencecenter::stockpiles.industry', compact('stockpile', 'report'));
    }
    ...
    public function workflow()
    {
        ...
        return view('eveintelligencecenter::stockpiles.workflow', compact('stockpiles', 'locations'));
    }
    ...
    public function createFromRequirements(Request $request)
    {
        ...
        if ($request->has('return_to_wizard')) {
            return redirect()->route('eveintelligencecenter::stockpiles.workflow', ['mode' => 'wizard', 'step' => 2])->with('success', 'Intermediate stockpile created.');
        }

        return redirect()->route('eveintelligencecenter::stockpiles')->with('success', 'New intermediate stockpile created.');
    }
}
