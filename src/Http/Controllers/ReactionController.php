...
use Apokavkos\EveIntelligenceCenter\Models\ReactionConfig;
use Apokavkos\EveIntelligenceCenter\Services\ReactionDataService;
use Apokavkos\EveIntelligenceCenter\Services\ReactionCalculatorService;
...
class ReactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('eveintelligencecenter::reactions.planner', compact('configs', 'defaultConfig', 'categories'));
    }
