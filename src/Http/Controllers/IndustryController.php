...
use Apokavkos\EveIntelligenceCenter\Services\BlueprintService;
use Apokavkos\EveIntelligenceCenter\Services\BlueprintImportService;
use Apokavkos\EveIntelligenceCenter\Services\CostCalculatorService;
use Apokavkos\EveIntelligenceCenter\Services\EveIndustryApiService;
use Apokavkos\EveIntelligenceCenter\Services\DataTables\AllAssetsDataTable;
...
class IndustryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('eveintelligencecenter::industry.calculator', compact('currentSystems'));
    }

    public function guide()
    {
        return view('eveintelligencecenter::industry.guide');
    }
    ...
    public function assets(Request $request, AllAssetsDataTable $dataTable)
    {
        ...
        return $dataTable->render('eveintelligencecenter::assets.index');
    }
