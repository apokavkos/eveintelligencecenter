...
namespace Apokavkos\EveIntelligenceCenter\Services;
...
class EveIndustryApiService
{
    ...
    {
        return Cache::remember('eveintelligencecenter.industry.costindex.' . $systemName, 3600, function () use ($systemName) {
            try {
    ...
    {
        return Cache::remember('eveintelligencecenter.industry.basecost.' . $typeId, 3600, function () use ($typeId) {
            try {
    ...
    {
        return Cache::remember('eveintelligencecenter.industry.market.' . $typeId, 600, function () use ($typeId) {
            try {
