...
<script>
    $(function() {
        ...
        function calculateRow($row) {
            ...
            return $.ajax({
                url: '{{ route("eveintelligencecenter::reactions.calculate") }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    name: name,
        ...
        function saveCurrentConfig() {
            ...
            $.post('{{ route("eveintelligencecenter::reactions.config.save") }}', data, function(res) {
        ...
        $('#warmup-btn').on('click', function() {
            ...
            $.get('{{ route("eveintelligencecenter::industry.warmup") }}', function() {
        ...
        $('#sync-prices-btn').on('click', function() {
            ...
            $.get('{{ route("eveintelligencecenter::reactions.warmup-prices") }}', function() {
