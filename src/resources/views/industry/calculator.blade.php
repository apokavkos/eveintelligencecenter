...
@include('eveintelligencecenter::industry.partials.blueprint-picker-modal')
...
<script>
    $(function() {
        ...
        $('#item-search').select2({
            ajax: {
                url: '{{ route("eveintelligencecenter::industry.search") }}',
                dataType: 'json',
                delay: 250,
        ...
        $('#system-search').select2({
            ajax: {
                url: '{{ route("eveintelligencecenter::industry.systems") }}',
                dataType: 'json',
                delay: 250,
                data: function (params) {
                    return { q: params.term };
        ...
        function updateSystemIndex(systemName) {
            ...
            $.get('{{ route("eveintelligencecenter::industry.system-index", "") }}/' + encodeURIComponent(systemName))
                .done(function(data) {
        ...
        function preloadBlueprints() {
            ...
            $.get('{{ route("eveintelligencecenter::industry.blueprints") }}')
                .done(function(data) {
                    allBlueprints = data;
        ...
        $(document).on('click', '.bp-use-btn', function() {
            ...
            $.get('{{ route("eveintelligencecenter::industry.blueprint.detail", "") }}/' + itemId, function(bp) {
        ...
        $('#calculate-btn').on('click', function() {
            ...
            $.ajax({
                url: '{{ route("eveintelligencecenter::industry.calculate") }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
