    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline mb-3">
                <div class="card-body">
                    <form id="hub-selection-form" action="{{ route('eveintelligencecenter::market.doctrine') }}" method="GET">
...
<script>
    ...
    function deleteGroup(id) {
        ...
        $.ajax({ url: '/eveintelligencecenter/market/groups/' + id, method: 'DELETE', data: { _token: '{{ csrf_token() }}' }, success: function() { location.reload(); } });
    }
