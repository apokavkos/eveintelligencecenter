            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(count($report['build_list']) > 0)
                        <form action="{{ route('eveintelligencecenter::stockpiles.from-requirements') }}" method="POST" style="display:inline;">
                            @csrf
            ...
            <div class="card-body py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 text-right">
                        <a href="{{ route('eveintelligencecenter::stockpiles.workflow') }}" class="btn btn-sm btn-outline-success">Full Guide</a>
                    </div>
                </div>
            </div>
        </div>
