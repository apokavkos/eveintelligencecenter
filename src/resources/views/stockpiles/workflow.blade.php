            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-right">
                        <div class="btn-group">
                            <a href="{{ route('eveintelligencecenter::stockpiles.workflow') }}" class="btn {{ !$isWizard ? 'btn-success' : 'btn-outline-success' }}">
                                <i class="fas fa-book-open mr-1"></i> Full Guide
                            </a>
                            <a href="{{ route('eveintelligencecenter::stockpiles.workflow', ['mode' => 'wizard']) }}" class="btn {{ $isWizard ? 'btn-success' : 'btn-outline-success' }}">
            ...
            <div class="card-body p-0">
                ...
                <div class="p-5 wizard-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="card border-primary p-3 shadow-sm">
                                    ...
                                    <form action="{{ route('eveintelligencecenter::stockpiles.store') }}" method="POST">
                                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card border-info p-3 h-100 shadow-sm">
                                    ...
                                    <p class="small text-muted">Go to the <a href="{{ route('eveintelligencecenter::stockpiles') }}" class="text-primary font-weight-bold">Dashboard</a> to add specific BPCs to your intermediate stockpiles by name.</p>
                                    <div class="mt-auto">
                                        <a href="{{ route('eveintelligencecenter::industry.calculator') }}" class="btn btn-outline-info btn-sm btn-block">Open Blueprint Search</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="wizard-step-5" class="wizard-step d-none text-center">
                                    ...
                                    <tbody>
                                        @foreach($stockpiles as $sp)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="{{ route('eveintelligencecenter::stockpiles.industry', $sp->id) }}" class="btn btn-xs btn-info">Analyze</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <a href="{{ route('eveintelligencecenter::stockpiles') }}" class="btn btn-xl btn-primary shadow-lg px-5 py-3">
    ...
    <div class="col-md-3">
        <div class="card card-outline card-primary shadow-sm sticky-top" style="top: 20px;">
            ...
            <div class="card-footer">
                <a href="{{ route('eveintelligencecenter::stockpiles') }}" class="btn btn-primary btn-block">
        ...
        <div id="step1" class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="alert alert-light border shadow-sm">
                    <i class="fas fa-lightbulb text-warning mr-2"></i> <strong>How to do it:</strong> Go to the <a href="{{ route('eveintelligencecenter::stockpiles') }}" class="text-primary font-weight-bold">Stockpiles Page</a>, and paste your final product names and quantities from the EVE Multi-buy window.
                </div>
            </div>
        </div>
    ...
    $(function() {
        @if($isWizard)
            ...
            $('#step2-stockpile-select').on('change', function() {
                ...
                $.get('{{ route("eveintelligencecenter::stockpiles.industry", ["id" => "REPLACE_ID"]) }}'.replace('REPLACE_ID', stockpileId), function(html) {
                    var $html = $(html);
